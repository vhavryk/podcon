...
public class TagResourceTest {
    ...
    public void initTest() {
        ...
        tag.setActual_order(DEFAULT_ACTUAL_ORDER);
    }
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getActual_order()).isEqualTo(DEFAULT_ACTUAL_ORDER);
    }
    ...
    public void updateTag() throws Exception {
        ...
        tag.setActual_order(UPDATED_ACTUAL_ORDER);
        ...
        assertThat(testTag.getActual_order()).isEqualTo(UPDATED_ACTUAL_ORDER);
    }
